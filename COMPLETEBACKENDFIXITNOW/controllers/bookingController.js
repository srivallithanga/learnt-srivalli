...
// Controller function to get bookings for a specific consumer
exports.getBookingsByConsumer = async (req, res) => {
  try {
      const bookings = await Booking.find({ consumer: req.params.consumerId })
          .populate('service')
          .populate('provider')
          .populate('category')
          .populate('consumer');
