...
import { Typography, Box, Grid, Divider, IconButton, List, ListItem, ListItemText, ListItemIcon, Container, TextField } from '@mui/material';
...
import adVideo from './ad-video1.mp4';
...
const ConsumerDashboard = () => {
  ...
  return (
    <>
      <Navbar /> <br />
      <Container maxWidth="lg" sx={{ padding: '2rem', marginTop: '64px' }}>
